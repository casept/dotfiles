...
const child_process = __webpack_require__(32);
function activate(_context) {
    const CMAKE_LANGUAGE = 'cmake';
    const CMAKE_SELECTOR = [
        { language: CMAKE_LANGUAGE, scheme: 'file' },
        { language: CMAKE_LANGUAGE, scheme: 'untitled' },
    ];
    coc_nvim_1.commands.registerCommand('cmake.onlineHelp', () => __awaiter(this, void 0, void 0, function* () { return yield onLineHelp(); }));
    coc_nvim_1.languages.registerHoverProvider(CMAKE_SELECTOR, new CMakeExtraInfoProvider());
    coc_nvim_1.languages.registerCompletionItemProvider('coc-cmake', 'CMAKE', 'cmake', new CMakeCompletionProvider(), [], config('priority'), []);
}
...
class CMakeCompletionProvider {
    ...
    document, position) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!doc)
                return [];
            const wordRange = doc.getWordRangeAtPosition(vscode_languageserver_protocol_1.Position.create(position.line, position.character - 1));
            if (!wordRange)
                return [];
    ...
    provideHover(document, position) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Promise.all([
                ...
                return promises[cmakeTypeFromComplKind(suggestion.kind)](suggestion.label).then((result) => {
...
function onLineHelp() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let position = yield coc_nvim_1.workspace.getCursorPosition();
        ...
        let result = yield coc_nvim_1.workspace.requestInput('Search on Cmake online documentation', currentWord);
        if (result != null) {
            if (result.length === 0) {
                result = currentWord;
            }
...
function cmake(args) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            let cmake_config = config('cmakePath', 'cmake');
            ...
            cmd.on("error", error => {
                if (error && error.code === 'ENOENT') {
                    coc_nvim_1.workspace.showMessage('The "cmake" command is not found in PATH.  Install it or use `cmake.cmakePath` in the workspace settings to define the CMake executable binary.', 'error');
                }
                reject();
            });
...
function cmake_help_variable(name) {
    ...
    }, _e => { }).then((name) => cmake(['--help-variable', name]), null);
}
...
function cmake_help_property(name) {
    ...
    }, _e => { }).then((name) => cmake(['--help-property', name]), null);
}
...
function cmake_help_module(name) {
    ...
    }, _e => { }).then((name) => cmake(['--help-module', name]), null);
}
...
function cmake_online_help(search) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Promise.all([
            ...
            let opener = __webpack_require__(33);
            let suggestions = Array.prototype.concat.apply([], results);
            if (suggestions.length == 0) {
...
function ComplKindFromCMakeCodeClass(kind) {
    switch (kind) {
        case "function":
    ...
    return vscode_languageserver_protocol_1.CompletionItemKind.Property; // TODO@EG additional mappings needed?
}
function cmakeTypeFromComplKind(kind) {
    switch (kind) {
